...
public class EditItemActivity extends AppCompatActivity implements Observer {
    ...
    public void saveItem(View view) {
        ...
        Dimensions dimension = new Dimensions(length_str, width_str, height_str);
        Item updated_item = new Item(title_str, maker_str, description_str, dimension,image, id);
        ItemController updated_item_controller = new ItemController(updated_item);
        updated_item_controller.setDimensions(dimension);
